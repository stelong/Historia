...
from assimulo.solvers import CVode, Dopri5
...
def rhs(voi, states, parameters):
    constants = initConsts(parameters)
    algebraic = computeAlgebraic(constants, states, voi)
    
    rates1 = -(algebraic[22]+algebraic[24]+algebraic[25]+algebraic[29]+algebraic[26]+algebraic[30]+algebraic[31]+algebraic[34]+algebraic[81]+algebraic[75]+algebraic[78]+algebraic[72]+algebraic[20])/constants[3]
    rates2 = (-(algebraic[22]+algebraic[30]+algebraic[75]*3.00000+algebraic[34]*3.00000+algebraic[27])*1.00000)/(constants[8]*constants[2])
    rates3 = (algebraic[1]-states[2])/algebraic[11]
    rates4 = (algebraic[2]-states[3])/algebraic[12]
    rates5 = (algebraic[3]-states[4])/algebraic[13]
    rates6 = (-(algebraic[20]+algebraic[25]+algebraic[31]+algebraic[24]+algebraic[26]+algebraic[28]+-2.00000*algebraic[34])*1.00000)/(constants[8]*constants[2])
    rates7 = (algebraic[4]-states[6])/algebraic[14]
    rates8 = (algebraic[5]-states[7])/algebraic[15]
    rates9 = (algebraic[6]-states[8])/algebraic[16]
    rates10 = (algebraic[7]-states[9])/algebraic[17]
    rates11 = (algebraic[8]-states[10])/constants[67]
    rates12 = (algebraic[9]-states[11])/algebraic[18]
    rates13 = algebraic[84]*(((algebraic[64]-algebraic[76])+algebraic[82]+algebraic[83])-(-2.00000*algebraic[75]+algebraic[72]+algebraic[78]+algebraic[81])/(2.00000*constants[8]*constants[2]))
    rates14 = (constants[8]/constants[9])*((-algebraic[64]+algebraic[76])-algebraic[82])
    rates15 = -(algebraic[57]+algebraic[65])*states[14]+algebraic[59]*states[15]+algebraic[67]*states[16]
    rates16 = (algebraic[57]*states[14]-(algebraic[59]+algebraic[69])*states[15])+algebraic[71]*algebraic[73]
    rates17 = (algebraic[65]*states[14]-(algebraic[67]+algebraic[61])*states[16])+algebraic[63]*algebraic[73]
    rates18 = algebraic[83]

    return np.array([rates1, rates2, rates3, rates4, rates5, rates6, rates7, rates8, rates9, rates10, rates11, rates12, rates13, rates14, rates15, rates16, rates17, rates18])
...
def main():
    ...
    tend = 170
    t, y = sim.simulate(tend, 0, np.arange(171))
